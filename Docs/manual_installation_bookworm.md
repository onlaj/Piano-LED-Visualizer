...
# Manual installation (legacy / Bookworm-era notes)

The steps below are kept for reference. On **Trixie**, several packages and the RTP MIDI install path changed - follow the Trixie guide instead.
