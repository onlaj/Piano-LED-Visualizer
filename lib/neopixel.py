...
def getRGB(colorValue):
    """Get the red, green, and blue color components from a 24-bit color value."""
...
class Adafruit_NeoPixel(object):
    ...
    def setBrightness(self, brightness):
        ...
        if now.hour >= 9 and now.hour < 18 and brightness < 128:  # if between 9am and 6pm
            brightness = int(brightness * 2) 
            print("Daylight, increase brightness")
        ws.ws2811_channel_t_brightness_set(self._channel, brightness)
