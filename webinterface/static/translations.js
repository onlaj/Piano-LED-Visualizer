...
const translations = {
    en: {
        ...
        light_number_means: "Note Number: 92, Offset: 2: For notes above 92, LEDs shifts 2 positions backwards (towards lower notes)",
    ...
    pl: {
        ...
        light_number_means: "Numer nuty: 92, Przesunięcie: 2: Dla nut powyżej 92 diody przesuwają się o 2 pozycje w lewo (w stronę niższych nut)",
    ...
    fr: {
        ...
        light_number_means: "Numéro de note : 92, Décalage : 2 : Pour les notes supérieures à 92, les LED se décalent de 2 positions vers l'arrière (vers les notes inférieures)",
    ...
    de: {
        ...
        light_number_means: "Notennummer: 92, Versatz: 2: Für Noten oberhalb von 92 werden die LEDs um 2 Positionen nach hinten verschoben (in Richtung niedrigerer Noten)",
    ...
    es: {
        ...
        light_number_means: "Número de nota: 92, Offset: 2: Para las notas superiores a 92, los LED se desplazan 2 posiciones hacia atrás (hacia notas más bajas)",
    ...
    zh: {
        ...
        light_number_means: "音符编号：92，偏移量：2：对于92以上的音符，LED将向后移动2个位置（朝向较低的音符）",
        light_number: "音符编号",
        note_offset: "音符偏移",
    ...
    hi: {
        ...
        light_number_means: "नोट नंबर: 92, ऑफसेट: 2: 92 से ऊपर की नोट्स के लिए, एलईडी 2 स्थान पीछे (निम्न नोट्स की ओर) शिफ्ट होती हैं",
    ...
    pt: {
        ...
        light_number_means: "Número da Nota: 92, Offset: 2: Para notas acima de 92, os LEDs são deslocados 2 posições para trás (em direção a notas mais baixas)",
    ...
    ja: {
        ...
        light_number_means: "ノート番号: 92, オフセット: 2: 92以上の音符の場合、LEDが2つ分後ろにシフトします（低い音符側へ）",
        light_number: "ノート番号",
    ...
    light_number_means: "노트 번호: 92, 오프셋: 2: 92번 이상의 노트에 대해, LED가 2칸 뒤로 이동합니다 (더 낮은 노트 방향으로)",
    light_number: "노트 번호",
    note_offset: "음표 오프셋",
